    ...
    t.expr[":"].notmdproc = function (o) {
        ...
        attachInputEventHandlers: function () {
            ...
            t(document).on("change", ".checkbox input[type=checkbox]", function () {
                ...
                var o = t(this),
                    i = o.closest(".form-group"),
                    e = void 0 === o[0].checkValidity || o[0].checkValidity();
                ...
                t.each(this.files, function (t, o) {
                    i += o.name + ", "
                }), (i = i.substring(0, i.length - 2)) ? o.removeClass("is-empty") : o.addClass("is-empty"), o.find("input.form-control[readonly]").val(i)
            })
        },
        ripples: function (o) {
...
function (t, o, i, n) {
    ...
    e.prototype.init = function () {
            ...
            if (!r.isTouch() || "mousedown" !== n.type) {
                ...
                if (a || s) {
                    ...
                    p.addClass("ripple").css({
                        ...
                        top: a,
                        "background-color": l
                    }), e.append(p), o.getComputedStyle(p[0]).opacity, r.rippleOn(i, p), setTimeout(function () {
                        r.rippleEnd(p)
        ...
        var i = t.offset();
        return r.isTouch() ? 1 === (o = o.originalEvent).touches.length && o.touches[0].pageX - i.left : o.pageX - i.left
    }, e.prototype.getRelY = function (t, o) {
        var i = t.offset();
        return r.isTouch() ? 1 === (o = o.originalEvent).touches.length && o.touches[0].pageY - i.top : o.pageY - i.top
